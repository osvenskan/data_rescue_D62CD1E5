...
#     if program_id == 'TidalBenthic':
#         import pprint; pp=pprint.pprint
#         import pdb; pdb.set_trace()

#         data_type_ids = [data_type_id for data_type_id in data_type_ids if data_type_id !='MonitorEvent']
#         data_type_ids = [data_type_id for data_type_id in data_type_ids if data_type_id !='Biomass']
#         data_type_ids = [data_type_id for data_type_id in data_type_ids if data_type_id !='Taxonomic']
